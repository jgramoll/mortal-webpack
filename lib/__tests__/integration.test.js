...
describe('mortal-kombat', function() {
  ...
  const features = [
    ...
    {
      name: 'generateCommonBundle: strict = false',
      input: () => [
        b.generateCommonBundle({
          name: 'app',
          modules: [ 'a', 'b' ],
...

    {
      ...
      specs: [
        ...
        assertions.hasPluginWithOptions('UglifyJsPlugin', {
          key: 'options',
          options: {
            sourceMap: true
          }
...

    {
      ...
      specs: [
        assertions.hasNoErrors(),
        assertions.hasProperty('module.loaders.0.loaders.0', `babel-loader?${JSON.stringify({presets: ["es2015"]})}`),
      ]
    },

    {
      ...
      specs: [
        assertions.hasNoErrors(),
        assertions.hasProperty('module.loaders.0.loaders.length', 1),
        assertions.hasProperty('module.loaders.0.loaders', [ 'babel-loader' ]),
      ]
    },
...

    {
      ...
      specs: [
        assertions.hasNoErrors(),
        assertions.hasPlugin('UglifyJsPlugin'),
      ]
    },
    {
      name: 'output',
